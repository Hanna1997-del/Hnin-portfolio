      ...
      <div className='flex flex-col gap-12 lg:flex-row pt-28 items-center justify-center mb-12 min-h-screen lg:mb-0 lg:pt-0 '>
        ...
        <div className='lg:w-1/2 lg:ml-8 max-w-md md:max-w-xl'>
          ...
          <p className='text-WhiteGray text-sm mt-8 leading-7'>
            {""}
            I am a passionate frontend developer with a creative eye for design and
           a strong focus on delivering elegant and intuitive interfaces.Excited to collaborate on new projects!</p>
